      ...
      <div class="row mt-3">
        ...
        <div class="col-md-6">
            <div class="row BestIngredientsRow" id="BestIngredients">
                ...
                <div class="col-md-11">
                <div class="row p-0 m-0">
                    <label id="BestIngredientsLabel" htmlFor='BestIngredientsRadio'>The food contains the best ingredients for <span>Bruno</span></label>
                </div>
                </div>
            </div>
        </div>
...
{/* footer */}
      <footer className=" footer  shadow py-4">
           <div className="row">
            ...
            <NavLink  to='/Eating-type' type="button" className="btn  back"><i class="fa fa-angle-left"></i>BACK</NavLink>
            
             <NavLink to='/help'  type="button" className="btn  float-end continue">CONTINUE <i className="fa fa-angle-right"></i></NavLink>
            </div>
            <div className="col-md-4"></div>
            </div>
           </footer>
