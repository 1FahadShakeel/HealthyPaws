...
function HealthInputHandler(){
    document.getElementById("HealthIssuesInput").classList.add("HealthIssuesFocused");
    document.getElementById("HealthIssuesInput").classList.remove("HealthIssuesBlured");
}
function HealthInputHandler2(){
    document.getElementById("HealthIssuesInput").classList.remove("HealthIssuesFocused");
    document.getElementById("HealthIssuesInput").classList.add("HealthIssuesBlured");
}
 ...
 <div className="row header py-5">
      ...
      {/* <div class="row mt-5">
        ...
        <div class="col-md-6 text-center">
          <input id="HealthIssuesInput" class="form-control d-none" placeholder='Health Issues...' onFocus={HealthInputHandler} onBlur={HealthInputHandler2}/>
        </div>
        <div class="col-md-3"></div>
      </div> */}
      ...
      <div class="row mt-5" id="FreshFact">
        ...
        <div class="col-md-8">
          <div class="row">
            ...
            <div class="col-md-2">
              <img id="FreshFact4" src={FreshFact7} />
            </div>
          </div>
          <div class="row">
            <div class="col-md-12">
      ...
      <footer className=" footer  shadow py-4">
           <div className="row">
            ...
            <NavLink  to='/Allergies' type="button" className="btn  back"><i className="fa fa-angle-left"></i>BACK</NavLink>
            
             <NavLink  to='/snacks'  type="button" className="btn  float-end continue">CONTINUE <i className="fa fa-angle-right"></i></NavLink>
            </div>
            <div className="col-md-4"></div>
            </div>
           </footer>
