...
import extraPlan from"../images/extraPlan.PNG";
  ...
  return (
    <div className='container-fluid'>
      ...
      <div class="row mt-5" id="DogDesc">
        ...
        <div className="row cardSection  py-5">
            <div className="col-md-3"></div>
            <div className="col-md-6  ">
           
            <div id='cardRow' className="row cardRow border shadow rounded-4">
        ...
        <footer className=" footer  shadow py-4">
           <div className="row">
            ...
            <NavLink  to='/plans-2' type="button" className="btn  back"><i className="fa fa-angle-left"></i>BACK</NavLink>
