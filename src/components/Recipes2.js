  ...
  return (
    <div class="container-fluid"  id="StartPage">
      ...
      <div class="row mt-5">
        ...
        <div class="col-md-4">
            ...
            {/* All Butternut Card */}
        <Card style={{ width: '23rem', height: '31rem', padding: '20px' }}>
                <Card.Img style={{ padding: '10px' }} variant="top" src={AllButterNut} />
              <Card.Body>
                <Card.Title id="CardHeading">All Butternut</Card.Title>
        ...
        <div class="col-md-4">
            ...
            <Card.Body>
                <Card.Title id="CardHeading">Mostly Butternut</Card.Title>
                <Card.Text id="CardText">
                  <p>500g/day</p>
                  <p id="MostlyButterNutDesc">Mix Butternut with his current foods</p>
                  <a id="MostlyButterNutDesc" href="#">How can I mix?</a>
                </Card.Text>
            </Card.Body>
                <Card.Body>
                <ul class="ks-cboxtags text-center SpinButton" >
      ...
      <div class="row mt-5" id="CenterPage">
        ...
        <div class="row mt-2">
            <div class="col-md-12 text-center">
                <img id="OngoingPlanImage" src={OngoingPlanImage} />
            </div>
        </div>
        ...
        <Card style={{ width: '23rem', height: '29rem', padding: '20px' }}>
              ...
              <Card.Body>
                ...
                <Card.Text id="CardText">
                  ...
                  <a id="MostlyButterNutDesc" href="#">StorageSpace?</a>
                </Card.Text>
              </Card.Body>
                <Card.Body>
                  <ul class="ks-cboxtags text-center SpinButton" >
    ...
    <footer className=" footer  shadow py-4">
           <div className="row">
            ...
            <NavLink  to='/plans-1' type="button" className="btn  back"><i className="fa fa-angle-left"></i>BACK</NavLink>
            
             <NavLink to='/plans-3'  type="button" className="btn  float-end continue">CONTINUE <i className="fa fa-angle-right"></i></NavLink>
            </div>
            <div className="col-md-4"></div>
            </div>
           </footer>
