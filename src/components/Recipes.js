...
import BeefUp from '../images/BeefUp.webp';
import ChickenUp from '../images/ChickenUp.webp';
import PorkUp from '../images/PorkUp.webp';
import TurkeyUp from '../images/TurkeyUp.webp';
import DuoDuckChicken from '../images/DuoDuckChicken.webp';
import PlantUp from '../images/PlantUp.webp';
import VeggieUp from '../images/VeggieUp.webp';
import SalmonUp from '../images/SalmonUp.webp';
...
function Check()
{
  if((document.getElementById("MealCard1").classlist).contains()){

  }

  // let Option = document.getElementById("MealCard1").classList;
  // if(Option.contains("onCardClicked")){
  //   Option.add("offCardClicked");
  //   Option.remove("onCardClicked");
  // }
  // else{
  //   Option.remove("offCardClicked");
  //   Option.add("onCardClicked");
  // }
}
  ...
  return (
    <div class="container-fluid"  id="CenterPage">
      ...
      <div class="row" id="LowerPage">
        ...
        <div class="row mt-5">
          ...
          <div class="col-md-6 text-center">
            ...
            <img id="MealReccomendations" src={MealReccomendations} />
          </div>
          <div class="col-md-3"></div>
        </div>
        ...
        <div class="container" id="CardsContainer">
          ...
          <div class="row mt-5">
            ...
            <div class="col-md-4">
              ...
              <Card.Body>
                <Card.Title id="CardHeading">Chicken You Out</Card.Title>
                <Card.Text id="CardText">
            ...
            <div class="col-md-4">
              ...
              {/* Turkey Card */}
            <Card style={{ width: '23rem', height: '28rem', padding: '20px' }}>
                <Card.Img style={{ padding: '10px' }} variant="top" src={TurkeyUp} />
              <Card.Body>
                <Card.Title id="CardHeading">Gobble Gobble Turkey</Card.Title>
                <Card.Text id="CardText">
      ...
      <div class="row mt-5">
        <div class="col-md-4">
          ...
          {/* Veggie Card */}
          <Card style={{ width: '23rem', height: '28rem', padding: '20px' }}>
                <Card.Img style={{ padding: '10px' }} variant="top" src={VeggieUp} />
              <Card.Body>
                <Card.Title id="CardHeading">Ready Steady Veggie</Card.Title>
                <Card.Text id="CardText">
        ...
        <div class="col-md-4">
          ...
          <Card style={{ width: '23rem', height: '28rem', padding: '20px' }} id="CardView">
                <Card.Img style={{ padding: '10px' }} variant="top" src={PlantUp} />
              <Card.Body>
                <Card.Title id="CardHeading">Plant Get Enough</Card.Title>
                <Card.Text id="CardText">
        ...
        <div class="col-md-4">
          ...
          {/* Salmon Card */}
          <Card style={{ width: '23rem', height: '28rem', padding: '20px' }}>
                <Card.Img style={{ padding: '10px' }} variant="top" src={SalmonUp} />
              <Card.Body>
                <Card.Title id="CardHeading">Salmon to Love</Card.Title>
                <Card.Text id="CardText">
    ...
    <footer className=" footer  shadow py-4">
           <div className="row">
            ...
            <NavLink  to='/petParent' type="button" className="btn  back"><i className="fa fa-angle-left"></i>BACK</NavLink>
            
             <NavLink to='/plans-2'  type="button" className="btn  float-end continue">CONTINUE <i className="fa fa-angle-right"></i></NavLink>
            </div>
            <div className="col-md-4"></div>
            </div>
           </footer>
