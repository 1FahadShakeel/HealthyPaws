...
{/* images */}
    ...
    <footer className=" footer  shadow py-4">
           <div className="row">
            ...
            <NavLink  to='/body-look' type="button" className="btn  back"><i class="fa fa-angle-left"></i>BACK</NavLink>
            
             <NavLink to='/Activity'  type="button" className="btn  float-end continue">CONTINUE <i className="fa fa-angle-right"></i></NavLink>
            </div>
            <div className="col-md-4"></div>
            </div>
           </footer>
