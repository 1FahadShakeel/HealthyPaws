      ...
      <div className="container-fluid ">
       ...
       <div className="row mt-5">
         <div className="col-md-12 text-center">
           <button className="btnDesign" id="girlId" onClick={girlbtnHandler}> Girl</button>
           <button className="btnDesign selectedbtn mx-3" id="boyId" onClick={boybtnHandler}> Boy</button>
         </div>
        </div>
       ...
       <div className="row my-5">
        <div className="col-md-12 text-center">
           ...
           <button className="btnDesign" id="yesId" onClick={yesNeutered}> Yes</button>
           <button className="btnDesign selectedbtn mx-3" id="noId" onClick={noNeutered}>No</button>
         </div>
       </div>
       ...
       <div className="row freshRow">
        ...
        <div className="col-md-3"></div>
           ...
           <div className="row">
            ...
            <NavLink  to='/' type="button" className="btn  back"><i class="fa fa-angle-left"></i>BACK</NavLink>
            
             <NavLink to='/Age'  type="button" className="btn  float-end continue">CONTINUE <i className="fa fa-angle-right"></i></NavLink>
            </div>
            <div className="col-md-4"></div>
            </div>
           </footer>
