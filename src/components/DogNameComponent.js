...
let dogNameHandler1 = (e) => {
  let firstDog=document.getElementById("dogName1Id").value;
  localStorage.setItem("dogName",firstDog);
};
...
<div className="footer shadow  text-center py-4">
    ...
    <NavLink to='/Gender' type="button" className="btn px-5 start-btn">LET'S START</NavLink>
